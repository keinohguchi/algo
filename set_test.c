...
static int test_set_is_subset(void)
{
	const struct test {
		const char	*const name;
		int		size1;
		...
		{
			.name		= "set_is_subset(): zero sets subset",
			.size1		= 0,
			.size2		= 0,
			.want		= 1,
		},
		{
			.name		= "set_is_subset(): 1 set each subset",
			.size1		= 1,
			.data1		= {1},
			.size2		= 1,
			.data2		= {2},
		...
		{
			.name		= "set_is_subset(): 2 set each subset",
			.size1		= 2,
			.data1		= {1, 2},
			.size2		= 2,
			.data2		= {3, 4},
		...
		{
			.name		= "set_is_subset(): 4 set each subset",
			.size1		= 4,
			.data1		= {1, 2, 3, 4},
			.size2		= 4,
			.data2		= {5, 6, 7, 8},
		...
		{
			.name		= "set_is_subset(): 8 set each subset",
			.size1		= 8,
			.data1		= {1, 2, 3, 4, 5, 6, 7, 8},
			.size2		= 8,
			.data2		= {15, 16, 17, 18, 19, 20, 21, 22},
		...
		{
			.name		= "set_is_subset(): 1 set duplicate subset",
			.size1		= 1,
			.data1		= {1},
			.size2		= 1,
			.data2		= {1},
		...
		{
			.name		= "set_is_subset(): 2 set duplicate subset",
			.size1		= 2,
			.data1		= {1, 2},
			.size2		= 2,
			.data2		= {2, 1},
		...
		{
			.name		= "set_is_subset(): 4 set duplicate subset",
			.size1		= 4,
			.data1		= {1, 2, 3, 4},
			.size2		= 4,
			.data2		= {3, 4, 1, 2},
		...
		{
			.name		= "set_is_subset(): 8 set duplicate subset",
			.size1		= 8,
			.data1		= {1, 2, 3, 4, 5, 6, 7, 8},
			.size2		= 8,
		...
		{
			.name		= "set_is_subset(): 1 and 2 set subset",
			.size1		= 1,
			.data1		= {1},
			.size2		= 2,
			.data2		= {2, 1},
		...
		{
			.name		= "set_is_subset(): 2 and 4 set subset",
			.size1		= 2,
			.data1		= {1, 2},
			.size2		= 4,
			.data2		= {2, 3, 4, 1},
		...
		{
			.name		= "set_is_subset(): 4 and 8 set subset",
			.size1		= 4,
			.data1		= {1, 2, 3, 4},
			.size2		= 8,
			.data2		= {3, 4, 1, 9, 8, 7, 6, 2},
			.want		= 1,
		},
		{
			.name		= "set_is_subset(): 1 and 2 set non subset",
			.size1		= 1,
			.data1		= {1},
			.size2		= 2,
			.data2		= {2, 3},
		...
		{
			.name		= "set_is_subset(): 2 and 4 set non subset",
			.size1		= 2,
			.data1		= {1, 2},
			.size2		= 4,
			.data2		= {2, 3, 4, 0},
		...
		{
			.name		= "set_is_subset(): 4 and 8 set non subset",
			.size1		= 4,
			.data1		= {1, 2, 3, 4},
			.size2		= 8,
			.data2		= {3, 4, 1, 9, 8, 7, 6, 0},
			.want		= 0,
		},
		{
			.name		= "set_is_subset(): 2 and 1 set non subset",
			.size1		= 2,
			.data1		= {2, 3},
			.size2		= 1,
			.data2		= {1},
		...
		{
			.name		= "set_is_subset(): 4 and 2 set non subset",
			.size1		= 4,
			.data1		= {2, 3, 4, 0},
			.size2		= 2,
			.data2		= {1, 2},
		...
		{
			.name		= "set_is_subset(): 8 and 4 set non subset",
			.size1		= 8,
			.data1		= {3, 4, 1, 9, 8, 7, 6, 0},
			.size2		= 4,
			.data2		= {1, 2, 3, 4},
			.want		= 0,
		},
	...
	for (t = tests; t->name; t++) {
		...
		got = set_is_subset(&s1, &s2);
		if (got != t->want) {
			fprintf(stderr, "%s: unexpected subset:\n\t- want: %d\n\t-  got: %d\n",
				t->name, t->want, got);
			goto err;
		}
		set_destroy(&s2);
